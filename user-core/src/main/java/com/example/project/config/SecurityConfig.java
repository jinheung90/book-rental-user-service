...
import com.example.project.auth.security.JwtAccessDeniedHandler;
import com.example.project.auth.security.JwtAuthenticationEntryPoint;
import com.example.project.auth.security.JwtFilter;
...
//        configuration.setAllowedOrigins(allowOrigins);
        ...
        ArrayList<String> testOrigin = new ArrayList<>();
        testOrigin.add("*");
        configuration.setAllowedOrigins(testOrigin);
